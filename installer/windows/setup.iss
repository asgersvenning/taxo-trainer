...
[Setup]
AppId={{D1A3F7B2-7489-4C8B-8723-9F9316C4E1A9}
AppName={#MyAppName}
...
OutputDir=..\..\dist
OutputBaseFilename=TaxoTrainerSetup
...
[Files]
Source: "..\..\dist\taxo-trainer\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
